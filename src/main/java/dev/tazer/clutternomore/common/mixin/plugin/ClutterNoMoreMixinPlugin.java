package dev.tazer.clutternomore.common.mixin.plugin;

import dev.tazer.clutternomore.common.mixin.annotation.IfAnyModPresent;
import dev.tazer.clutternomore.common.mixin.annotation.IfDevEnvironment;
import dev.tazer.clutternomore.common.mixin.annotation.IfModAbsent;
import dev.tazer.clutternomore.common.mixin.annotation.IfModPresent;
import dev.tazer.clutternomore.common.mixin.annotation.IfNotDevEnvironment;
//? if fabric {
...
public class ClutterNoMoreMixinPlugin implements IMixinConfigPlugin {
    private static final Logger LOGGER = LogManager.getLogger("ClutterNoMore Mixin Plugin");
    //? if fabric {
    ...
    *///?}
    ...
    public void onLoad(String mixinPackage) {
        ...
        //? if fabric {
        this.presentMods = FabricLoader.getInstance().getAllMods().stream()
